            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="max-w-sm w-full lg:max-w-full lg:flex">
                        <div class="px-6 py-4">
                            <div class="font-bold text-xl mb-2">Permission Update Page</div>
                            <hr>
                            <form class="max-w-sm mx-auto bg-dark" @submit.prevent="submit">
                                <div class="mb-5">
                                    <label for="role_name"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-whitedark:text-gray-400">Permission
                                        Name</label>
