            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="max-w-sm w-full lg:max-w-full lg:flex">
                        <div class="px-6 py-4">
                            <div class="font-bold text-xl mb-2">Users Update Page</div>
                            <hr>
                            <form class="max-w-sm mx-auto bg-dark" @submit.prevent="submit">
                                ...
                                <div class="mb-5">
                                    <label for="role_name"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-whitedark:text-gray-400">User
                                        Email</label>
                                    <input type="text" id="role_email" v-model="form.email"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                                ...
                                <div class="mb-5">
                                    <label for="role_name"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-whitedark:text-gray-400">User
                                        Password</label>
                                    <input type="text" id="role_name" v-model="form.password"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
